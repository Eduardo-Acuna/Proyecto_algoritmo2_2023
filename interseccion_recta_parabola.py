...
ventana = tk.Tk()
ventana.title("Calculadora de Interseccion Recta y Parábola con Gráfico")
...
titulo = tk.Label(ventana, text="Interseccion entre Recta y Parábola", font=("Serif", 30), fg="white", bg="#3b598d")
