...
def calcular_interseccion_circunferencia_parabola_y_grafico():

    
    circunferencia = entrada_circunferencia.get()
    parabola = entrada_parabola.get()
    ...
    if bandera == 'x2':
        ...
        x_parabola = np.linspace(k - 5, k + 5, 400)
...
def limpiar():
    entrada_circunferencia.delete(0, 'end')
...
ventana = tk.Tk()
ventana.title("Calculadora de Interseccion Circunferencia y Parabola con Gráfico")
...
titulo = tk.Label(ventana, text="Interseccion entre Circunferencia y Parabola", font=("Serif", 30), fg="white", bg="#3b598d")
titulo.grid(row=0, column=0, columnspan=3, pady=20, sticky="ew")


# Crear variables para los coeficientes y el resultado
entrada_parabola = tk.Entry(ventana, width=13)
entrada_circunferencia = tk.Entry(ventana, width=13)
resultado = tk.StringVar()

# Etiquetas y entradas de usuario
subtitulo1 = tk.Label(ventana, text="Ingrese la ecuacion de la\nCircunferencia:", font=("Helvetica", 13), fg="white", bg="#3b598d")
subtitulo1.grid(row=1, column=0, columnspan=2)
entrada_circunferencia.grid(row=2, column=0, sticky="ew", columnspan=2, padx=10, pady=10)

subtitulo2 = tk.Label(ventana, text="Ingrese la ecuacion de la Parabola.:", font=("Helvetica", 13), fg="white", bg="#3b598d")
subtitulo2.grid(row=3, column=0, columnspan=2)
entrada_parabola.grid(row=4, column=0, sticky="ew", columnspan=2, padx=10, pady=10)
...
# Botones
boton_calcular = ttk.Button(ventana, text="Calcular interseccion y Gráficar", command=calcular_interseccion_circunferencia_parabola_y_grafico)
