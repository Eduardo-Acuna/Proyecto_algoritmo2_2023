...
class Opcion:
    ...
    def crear_interfaz(self):
        ...
        self.titulo = tk.Label(self.menu_principal, text="MENÚ DE ELECCIÓN DE OPERACIÓN", font=("Helvetica", 30))
        ...
        self.marco = tk.Frame(self.menu_principal)
        self.marco.pack()
        ...
        for nombre, funcion in operaciones:
            ...
            estilo_boton.configure(f"Estilo.{nombre}.TButton", font=("Helvetica", 13), padding=10)
