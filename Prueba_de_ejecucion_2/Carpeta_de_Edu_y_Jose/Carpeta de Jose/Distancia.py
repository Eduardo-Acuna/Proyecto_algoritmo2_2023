...
def calcular_distancia_y_grafico():
    ...
    resultado.set(f"Distancia A y B: {distancia:.2f} unidades")
    ...
    plt.plot([x1, x2], [y1, y2], color='blue', label='Línea que conecta los puntos')
    plt.legend()
    plt.title('Distancia entre Punto A y Punto B')
    canvas.draw()
